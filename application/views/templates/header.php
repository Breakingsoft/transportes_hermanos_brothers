    ...
    <div class="slider-wrappear theme-dark">
                ...
                <div id="slider" class="nivoSlider">
                    <?php foreach ($hero_images as $hero_images_data): ?>
                         <img src="<?php echo $hero_images_data['uri'].$hero_images_data['file_name'];?>" data-thumb="<?php echo $hero_images_data['uri'].strrpos($hero_images_data['file_name'],'.')[0].'thumbnail.jpg';?>">
                    <?php endforeach;?>
                </div>    
    </div>
</div>          
